...
urlpatterns = [
    ...
    path(
        "test-generic-n-plus-one/",
        views.test_generic_relation_n_plus_one_view,
        name="test_generic_n_plus_one",
    ),
    path(
        "test-generic-ok/", views.test_generic_relation_ok_view, name="test_generic_ok"
    ),
    path(
        "test-deferred/",
        views.test_deferred_fields_n_plus_one_view,
        name="test_deferred",
    ),
